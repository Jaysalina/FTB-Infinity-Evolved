...
echo ###   Jaysalina   ###
echo #####################
echo java -server -Xms6G -Xmx8G -jar cauldron-server.jar -d64 nogui
java -server -Xms6G -Xmx8G -jar cauldron-server.jar -d64 nogui
...
if exist autostart.stamp (
    ...
    echo Starting Again!
    java -server -Xms8G -Xmx8G -jar cauldron-server.jar nogui
